# dev_next.ps1 v40 - list podcast domain files from encrypted manifest
$computer = $env:COMPUTERNAME
Write-Host "[$computer] dev_next.ps1 v40 - list podcast manifest files"
...
Write-Host "[$computer] v40 complete."
